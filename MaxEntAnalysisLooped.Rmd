...
#### CP Notes - 1/27 - I think this will all be different with bootstrap replicates, and all our new runs.

# Info for calling threshold value from maxentResults output
## maxentResults.csv
## Averaged values all in 
#       ROW 102 (if run done correctly)
#       Column = "A" titled "Species", 
#       cell value = "Quercus_tomentella (average)"
# 
# Other values we'll want, still in ROW 102
##  "Training AUC"

...
#If else statements for scenarios

island_outlines<-read_sf("G:/data/islands/all_islands/Channel_Islands_CUSP/Channel_Islands_CUSP_Teale_Albers/Channel_Islands_CUSP_Teale_Albers.shp")

min_data<-raster("G:/data/climate/GISModel_Input/historic/cwd1981_2010_ave_HST_1539127145.tif")

crop <- crop(r, extent(island_outlines))
extent <- mask(r2, SPDF)

## Check that it worked
plot(r3)
extent<-crop(mask, island_outlines)
...
#save final file as 
paste0("G:/data/islands/MaxEnt/Extent/", scenario, ".tif")

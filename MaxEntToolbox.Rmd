...
sri_oaks<-read_sf("G:/data/islands/sri/OakPoint/SRI_OakPoints_AEA.shp")
scr_oaks<-read_sf("G:/data/islands/scr/OakPoint/SCROakPoints_AEA.shp")
#Merge all the oak points and save as below shape file
all_oaks<-st_union(sca_oaks, sri_oaks, scr_oaks)
write_sf(all_oaks, filename="G:/data/islands/MaxEnt/Processing/Oak/all_oaks.shp", overwrite=TRUE)

oaksxy <- coordinates(all_oaks)
oaksxy$Species<-"Quercus tomentella"

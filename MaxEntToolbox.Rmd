...
#scr_fogelev_270m
#sri_fogelev_270m
#scr_fogconstant_270m #ADD
#sri_fogconstant_270m #ADD
#MainlandCA
...
Fog
#Need to account for different time steps
#Need to change future fog time period for each raster read in
...
if (scenario=="scr_foginc_270m"){
  ...
  future_fog_10_40<-raster("G:/data/climate/Fog/Fog_270/PercentChange/scr_all_increase20_270.tif")
  future_fog_40_70<-raster("G:/data/climate/Fog/Fog_270/PercentChange/scr_all_increase20_270.tif")
  future_fog_70_100<-raster("G:/data/climate/Fog/Fog_270/PercentChange/scr_all_increase20_270.tif")
  
}else if (scenario=="scr_fogdec_270m"){
  #Future fog changed by a percent (20%) Inc/Dec for SRI and SCR
  current_fog<-raster("G:/data/climate/Fog/Fog_270/Historic/scr_allfog_270.tif")
  future_fog_10_40<-raster("G:/data/climate/Fog/Fog_270/PercentChange/scr_all_decrease20_270.tif")
  future_fog_40_70<-raster("G:/data/climate/Fog/Fog_270/PercentChange/scr_all_decrease20_270.tif")
  future_fog_70_100<-raster("G:/data/climate/Fog/Fog_270/PercentChange/scr_all_decrease20_270.tif")

}else if (scenario=="sri_foginc_270m"){
  #Future fog changed by a percent (20%) Inc/Dec for SRI and SCR
  current_fog<-raster("G:/data/climate/Fog/Fog_270/Historic/sri_allfog_270.tif")
  future_fog_10_40<-raster("G:/data/climate/Fog/Fog_270/PercentChange/sri_all_increase20_270.tif")
  future_fog_40_70<-raster("G:/data/climate/Fog/Fog_270/PercentChange/sri_all_increase20_270.tif")
  future_fog_70_100<-raster("G:/data/climate/Fog/Fog_270/PercentChange/sri_all_increase20_270.tif")

}else if (scenario=="sri_fogdec_270m"){
  #Future fog changed by a percent (20%) Inc/Dec for SRI and SCR
  current_fog<-raster("G:/data/climate/Fog/Fog_270/Historic/sri_allfog_270.tif")
  future_fog_10_40<-raster("G:/data/climate/Fog/Fog_270/PercentChange/sri_all_decrease20_270.tif")
  future_fog_40_70<-raster("G:/data/climate/Fog/Fog_270/PercentChange/sri_all_decrease20_270.tif")
  future_fog_70_100<-raster("G:/data/climate/Fog/Fog_270/PercentChange/sri_all_decrease20_270.tif")

}else if (scenario=="scr_fogelev_270m"){
  #Future Fog Elevation (+-20%): SRI and SCR
  current_fog<-raster("G:/data/climate/Fog/Fog_270/Historic/scr_allfog_270.tif")
  future_fog_10_40<-raster("G:/data/climate/Fog/Fog_270/Elevation/scr_all_elevation20.tif")
  future_fog_40_70<-raster("G:/data/climate/Fog/Fog_270/Elevation/scr_all_elevation20.tif")
  future_fog_70_100<-raster("G:/data/climate/Fog/Fog_270/Elevation/scr_all_elevation20.tif")
  
}else if (scenario=="sri_fogelev_270m"){
  #Future Fog Elevation (+-20%): SRI and SCR
  current_fog<-raster("G:/data/climate/Fog/Fog_270/Historic/sri_allfog_270.tif")
  future_fog_10_40<-raster("G:/data/climate/Fog/Fog_270/Elevation/sri_all_elevation20.tif")
  future_fog_40_70<-raster("G:/data/climate/Fog/Fog_270/Elevation/sri_all_elevation20.tif")
  future_fog_70_100<-raster("G:/data/climate/Fog/Fog_270/Elevation/sri_all_elevation20.tif")

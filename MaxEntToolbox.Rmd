...
***RUN THIS CODE for all scenarios ONCE SRI OAKS shp REPLACED
...
#Have to write a code that goes through the climate folders and inserts current into historic and 
  ...
  future_fog_new <- resample(future_fog, scen_extent, "ngb")
  ...
  future_fog_crop <- crop(future_fog_new, scen_extent) #Crop to extent of outlines
  ...
  extent(future_fog_mask)<-round(extent(future_fog_mask),1)
